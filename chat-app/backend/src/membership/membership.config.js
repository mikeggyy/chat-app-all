...
export const MEMBERSHIP_TIERS = {
  ...
  free: {
    ...
    features: {
      ...
      // 解鎖票與卡片
      characterUnlockTickets: 0,          // 開通時送的角色解鎖票（用於永久解鎖與角色的無限對話）
  ...
  vip: {
    ...
    features: {
      ...
      // 解鎖票與卡片（開通時一次發放）
      characterUnlockTickets: 10,         // 開通時送 10 張角色解鎖票（用於永久解鎖與角色的無限對話）
  ...
  vvip: {
    ...
    features: {
      ...
      // 解鎖票與卡片（開通時一次發放）
      characterUnlockTickets: 30,         // 開通時送 30 張角色解鎖票（用於永久解鎖與角色的無限對話）
