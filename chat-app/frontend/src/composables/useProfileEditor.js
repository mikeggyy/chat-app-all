 ...
 */
const buildNormalizedProfile = (sourceProfile = {}) => ({
...
/**
 * 個人資料編輯器 Composable
 * @param {Object} profile - 當前個人資料
 * @param {Function} onUpdate - 更新回調函數
 * @returns {Object} 編輯器狀態和方法
 */
export function useProfileEditor(profile, onUpdate) {
  // ==================== 狀態管理 ====================
   ...
   * 監聽表單變化
   */
  const watchFormField = (field, value) => {
